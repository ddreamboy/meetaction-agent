...
- object: ПОЛНОЕ описание без местоимений — раскрывай "это", "там", "туда" через контекст; если раскрыть нельзя — поле опускай
...
- context_quote: дословная цитата из транскрипта (1–2 предложения), которая ДОКАЗЫВАЕТ что это будущий коммитмент, а не отчёт о прошлом
